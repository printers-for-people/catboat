...
Kalico functions working and even mask access to some print boards.
...
"status" command will report the printer is ready if the Kalico
...
Kalico reports error messages via the command console and via pop up in
